        ...
        <AnimatePresence>
          {chapterDropdownOpen && (
            <motion.div
              ...
              className="fixed z-50 bg-card border border-border shadow-lg rounded-sm p-3 w-[min(280px,90vw)] max-h-[240px] overflow-y-auto"
              style={{ top: dropdownRef.current ? dropdownRef.current.getBoundingClientRect().bottom + 8 : undefined, left: '50%', transform: 'translateX(-50%)' }}
            >
