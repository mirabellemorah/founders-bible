// Complete Bible book list with chapter counts for the full Bible browser
export interface BibleBook {
  name: string;
  chapters: number;
  testament: "OT" | "NT" | "DC"; // Old Testament, New Testament, Deuterocanonical
}
...
export const bibleBooks: BibleBook[] = [
  ...
  // Deuterocanonical
  { name: "Tobit", chapters: 14, testament: "DC" },
  { name: "Judith", chapters: 16, testament: "DC" },
  { name: "Wisdom of Solomon", chapters: 19, testament: "DC" },
  { name: "Sirach", chapters: 51, testament: "DC" },
  { name: "Baruch", chapters: 6, testament: "DC" },
  { name: "1 Maccabees", chapters: 16, testament: "DC" },
  { name: "2 Maccabees", chapters: 15, testament: "DC" },
];

export function getBooksByTestament(testament: "OT" | "NT" | "DC") {
